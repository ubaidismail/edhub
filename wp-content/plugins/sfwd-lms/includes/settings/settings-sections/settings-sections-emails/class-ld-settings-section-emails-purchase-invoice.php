...
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( ! class_exists( 'LearnDash_Settings_Section_Emails_Purchase_Invvoice' ) ) ) {
	...
	class LearnDash_Settings_Section_Emails_Purchase_Invoice extends LearnDash_Settings_Section {
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields['company_logo'] = array(
				...
				'help_text'         => esc_html__( 'This logo will appear on the Purchase Invoice template. Optional.', 'learndash' ),
