 ...
 * @param int $post_id Course/Group post ID.
 *
 * @return string $pdf_data['filename'] File name of generated PDF
 */
function learndash_send_purchase_invoice_email( $user_id = 0, $post_id = 0 ) {
	$user_id = absint( $user_id );
